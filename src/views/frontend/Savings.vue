      ...
      <div class="container md:py-40 py-20 mx-auto">
        <div class="flex flex-wrap mx-5">
          ...
          <div class="md:px-4 px-1 lg:w-7/12 w-full lg:ml-auto">
            ...
            <div class="w-full text-center bg-amber-600 rounded-3xl my-3">
              <h2 class="my-1 md:text-4xl text-2xl font-semibold leading-tight text-white capitalize">
                Latest Savings tracker
              </h2>

              <div class="relative overflow-x-auto">
                <table class="w-full border-separate bg-amber-800 text-white">
                  <thead>
                    <tr>
